...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            RenewalMain: 'src/main/js/reactjs/renewals/components/RenewalMain.jsx',
            RenewalLine: 'src/main/js/reactjs/renewals/components/RenewalLine.jsx',
            RenewalList: 'src/main/js/reactjs/renewals/components/RenewalList.jsx',
            RenewalDetail: 'src/main/js/reactjs/renewals/components/RenewalDetail.jsx',
            RenewalForm: 'src/main/js/reactjs/renewals/components/RenewalForm.jsx',
            RenewalInfo: 'src/main/js/reactjs/renewals/components/RenewalInfo.jsx',
            ...
            ImportRenewalForm: 'src/main/js/reactjs/renewals/components/ImportRenewalForm.jsx',
            ...
            ImportRenewalMain: 'src/main/js/reactjs/renewals/components/ImportRenewalMain.jsx',
