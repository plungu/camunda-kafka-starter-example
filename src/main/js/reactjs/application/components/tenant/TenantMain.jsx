...
const client = require('../../service-request/components/client.jsx');
const follow = require('../../service-request/components/follow.jsx'); // function to hop multiple links by "rel"
