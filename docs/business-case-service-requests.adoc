...
image:./images/service-request-workflow-model.png[Service Request BPMN]

#### Some interesting points in the process
image:./images/service-request-approval-and-integration.png[Service Request BPMN]
====
...
image:./images/service-request-error-handling.png[Service Request BPMN]
====
...
====
image:./images/service-request-biz-calcs.png[Service Request BPMN]
====
...
image:./images/service-request-architecture.png[Service Request BPMN]
====
